  ...
  const userListing = async () => {
    ...
    const staticData = [
      ...
      },
      {
        id: 6,
        full_name: "T-800",
        emailid: "terminator@example.com",
        role: "policyholder",
        status: "active",
      },
      {
    ...
    <>
                    ...
                    <TableCell>
                      ...
                      {userDatas?.role === "admin" && (
                        <Tooltip title="Update password">
                          <IconButton
                            onClick={() => OpenModal2(row, row.status)}
                          >
                            <TbPasswordUser />
                          </IconButton>
                        </Tooltip>
      ...
      <Dialog open={open2} onClose={handleClose2} maxWidth="xs" fullWidth>
        ...
        <DialogActions sx={{ justifyContent: "center", pb: 2 }}>
          ...
          <Button onClick={() => PasswordUpdateHandler(open2?.id)}>
            Update
          </Button>
        </DialogActions>
      </Dialog>
